                ...
                <AreaChart data={data?.dailyRevenue ?? []} margin={{ top: 8, right: 12, left: -16, bottom: 0 }}>
                  <defs>
                    <linearGradient id="revenueGrad" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%"  stopColor="oklch(0.66 0.24 168)" stopOpacity={0.25} />
                      <stop offset="95%" stopColor="oklch(0.66 0.24 168)" stopOpacity={0.02} />
                    </linearGradient>
                  </defs>
                  ...
                  <Area
                    ...
                    stroke="oklch(0.66 0.24 168)" strokeWidth={2.5}
                    fill="url(#revenueGrad)"
                    dot={{ r: 3, fill: "oklch(0.66 0.24 168)", strokeWidth: 0 }}
                    activeDot={{ r: 5, fill: "oklch(0.66 0.24 168)", strokeWidth: 0 }}
                  />
                </AreaChart>
              </ResponsiveContainer>
            )}
