...
const PIE_COLORS = [
  "oklch(0.66 0.24 168)", "oklch(0.60 0.18 200)", "oklch(0.70 0.17 260)",
...
function PctBadge({ pct }: { pct: number | null }) {
  ...
  return (
    <span className="inline-flex items-center gap-0.5 text-[11px] font-bold px-1.5 py-0.5 rounded-full"
      style={{ background: up ? "oklch(0.93 0.08 168)" : "oklch(0.96 0.05 25)", color: up ? G.primaryDk : "oklch(0.50 0.22 25)" }}>
          ...
          {isLoading ? <Skeleton className="h-56 rounded-xl" /> : (
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={data?.dailyData ?? []} margin={{ left: -8, right: 4 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="oklch(0.93 0.018 168)" vertical={false} />
