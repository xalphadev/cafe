...
const G = {
  ...
  card:       "oklch(0.995 0.003 168)",
  grad:       "linear-gradient(160deg, oklch(0.66 0.24 168) 0%, oklch(0.44 0.22 182) 100%)",
  gradLight:  "linear-gradient(160deg, oklch(0.66 0.24 168) 0%, oklch(0.44 0.22 182) 100%)",
...
export function MenuClient() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      {/* ── Header ── */}
      <header className="sticky-header bg-white" style={{ boxShadow: "0 1px 0 oklch(0.93 0.018 168)" }}>
    ...
    >
      ...
      <div className="relative w-full overflow-hidden" style={{ aspectRatio: "1/1" }}>
        {product.image ? (
          ...
          <div className="w-full h-full flex items-center justify-center" style={{ background: "oklch(0.92 0.10 168)" }}><UtensilsCrossed className="w-10 h-10 text-gray-300" /></div>
        )}
        ...
        <span className="absolute top-2.5 left-2.5 text-[10px] font-extrabold px-2.5 py-1 rounded-full"
          style={{ background: "rgba(255,255,255,0.88)", color: "oklch(0.44 0.22 182)", backdropFilter: "blur(6px)" }}>
        ...
        {qty > 0 && (
          <span className="absolute bottom-2.5 right-2.5 w-6 h-6 rounded-full flex items-center justify-center text-[11px] font-extrabold"
            style={{ background: "oklch(0.66 0.24 168)", color: "white",
      ...
      <div className="px-3 pt-2.5 pb-3 flex flex-col gap-2.5 flex-1">
        <div className="flex-1">
          <h3 className="font-bold text-[13px] leading-snug line-clamp-2"
            style={{ color: "oklch(0.13 0.02 168)" }}>
            {product.name}
          </h3>
          {product.description && (
            <p className="text-[11px] mt-0.5 line-clamp-1"
              style={{ color: "oklch(0.50 0.04 168)" }}>
              {product.description}
            </p>
          )}
          {hasOptions && (
        ...
        <div className="flex items-center justify-between">
          <div>
            {isSaleActive ? (
              ...
              <span className="font-extrabold text-sm" style={{ color: "oklch(0.66 0.24 168)" }}>
                {formatPrice(product.price)}
              </span>
            )}
          ...
          {shopClosed ? (
            ...
            <button
              ...
              style={{ background: "linear-gradient(135deg, oklch(0.67 0.19 168), oklch(0.44 0.22 182))",
            ...
            <div className="flex items-center gap-1.5 rounded-xl px-1 py-1"
              ...
              <button onClick={onDecrease}
                ...
                <Minus className="w-3.5 h-3.5" style={{ color: "oklch(0.66 0.24 168)" }} strokeWidth={2.5} />
              </button>
              <span className="text-sm font-extrabold w-5 text-center" style={{ color: "oklch(0.13 0.02 168)" }}>{qty}</span>
