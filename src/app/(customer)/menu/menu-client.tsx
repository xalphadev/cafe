...
const G = {
  ...
  gradLight:  "linear-gradient(160deg, oklch(0.68 0.20 148) 0%, oklch(0.45 0.16 152) 100%)",
        ...
        <div className="flex items-center justify-between">
          ...
          {shopClosed ? (
            ...
            <button
              ...
              style={{ background: "linear-gradient(135deg, oklch(0.67 0.19 148), oklch(0.46 0.17 150))",
