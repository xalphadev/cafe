...
const G = {
  ...
  gradLight:  "linear-gradient(160deg, oklch(0.69 0.21 152) 0%, oklch(0.50 0.22 155) 100%)",
  shadow:     "0 8px 24px oklch(0.55 0.20 152 / 0.28)",
  shadowSm:   "0 2px 12px oklch(0.62 0.20 152 / 0.14)",
};
              ...
              >
                ...
                {mounted && itemCount() > 0 && (
                  <span
                    ...
                    style={{ background: G.grad, boxShadow: "0 2px 6px oklch(0.55 0.20 152 / 0.4)" }}
                  >
                    {itemCount()}
                  </span>
                )}
          ...
          {[{ id: "all", name: "ทั้งหมด" }, ...(!catLoading ? categories : [])].map(cat => (
            <button
              ...
              style={{
                ...
                boxShadow: selectedCategory === cat.id ? "0 3px 10px oklch(0.55 0.20 152 / 0.25)" : "none",
...
function ProductCard({ product, qty, shopClosed, isFavorited, onFavorite, onOpen, onAdd, onIncrease, onDecrease }: {
  ...
  return (
    <div
      ...
      style={{ boxShadow: "0 2px 12px oklch(0.55 0.20 152 / 0.12), 0 0 0 1px oklch(0.92 0.04 152)" }}
      onClick={onOpen}
    >
      {/* Image */}
      <div className="relative w-full overflow-hidden" style={{ aspectRatio: "1/1" }}>
        ...
        <span className="absolute top-2.5 left-2.5 text-[10px] font-extrabold px-2.5 py-1 rounded-full"
          style={{ background: "rgba(255,255,255,0.88)", color: "oklch(0.50 0.22 155)", backdropFilter: "blur(6px)" }}>
        ...
        {qty > 0 && (
          <span className="absolute bottom-2.5 right-2.5 w-6 h-6 rounded-full flex items-center justify-center text-[11px] font-extrabold"
            style={{ background: "oklch(0.69 0.21 152)", color: "white",
      ...
      <div className="px-3 pt-2.5 pb-3 flex flex-col gap-2.5 flex-1">
        <div className="flex-1">
          <h3 className="font-bold text-[13px] leading-snug line-clamp-2"
            style={{ color: "oklch(0.13 0.02 152)" }}>
            {product.name}
          </h3>
          {product.description && (
        ...
        <div className="flex items-center justify-between">
          <div>
            {isSaleActive ? (
              ...
              <span className="font-extrabold text-sm" style={{ color: "oklch(0.69 0.21 152)" }}>
                {formatPrice(product.price)}
              </span>
            )}
          ...
          {shopClosed ? (
            ...
            <button
              ...
              style={{ background: "linear-gradient(135deg, oklch(0.69 0.21 152) 0%, oklch(0.50 0.22 155) 100%)",
                       color: "white", boxShadow: "0 4px 12px oklch(0.55 0.20 152 / 0.35)" }}
            >
            ...
            <div className="flex items-center gap-1.5 rounded-xl px-1 py-1"
              ...
              <button onClick={onDecrease}
                ...
                style={{ boxShadow: "0 1px 3px oklch(0.55 0.20 152 / 0.15)" }}>
                <Minus className="w-3.5 h-3.5" style={{ color: "oklch(0.69 0.21 152)" }} strokeWidth={2.5} />
              </button>
              <span className="text-sm font-extrabold w-5 text-center" style={{ color: "oklch(0.13 0.02 152)" }}>{qty}</span>
...
function ProductSkeleton() {
  return (
    <div className="rounded-3xl overflow-hidden bg-white" style={{ boxShadow: "0 1px 8px oklch(0.62 0.20 152 / 0.08)" }}>
