      ...
      <header className="sticky-header bg-white/90 backdrop-blur-md border-b border-gray-100">
        <div className="flex items-center gap-3 px-4 h-14 pt-2">
          ...
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full"
            style={{ background: countdown < 120 ? "oklch(0.97 0.04 25)" : "oklch(0.95 0.02 162)" }}>
          ...
          {qrSrc && (
            <div className="flex justify-center px-6 py-5">
              <div className="relative p-4 rounded-2xl bg-white"
                style={{ border: "2px solid oklch(0.90 0.06 162)", boxShadow: "0 4px 20px oklch(0.55 0.18 148 / 0.12)" }}>
                <Image
                  src={qrSrc}
                  alt="QR PromptPay"
                  width={220}
