...
const G = {
  ...
  gradLt:  "linear-gradient(135deg, oklch(0.59 0.178 150) 0%, oklch(0.48 0.160 152) 100%)",
          ...
          {qrSrc && (
            <div className="flex justify-center px-6 py-5">
              <div className="relative p-4 rounded-2xl bg-white"
                style={{ border: "2px solid oklch(0.90 0.06 152)", boxShadow: "0 4px 20px oklch(0.48 0.140 152 / 0.12)" }}>
                <Image
                  src={qrSrc}
                  alt="QR PromptPay"
                  width={220}
            ...
            {slipUploaded ? (
              ...
              >
                <div className="w-12 h-12 rounded-2xl bg-white flex items-center justify-center"
                  style={{ boxShadow: "0 2px 8px oklch(0.48 0.140 152 / 0.15)" }}>
