          ...
          {TABS.map((t) => {
            ...
            return (
              <button
                ...
                style={isSelected ? { background: "oklch(0.66 0.24 168)" } : {}}
              >
                {t.label}
                {cnt > 0 && (
                  <span className={cn(
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <div
              ...
              style={{ background: "oklch(0.97 0.02 168)" }}
            >
              {tab === "cancelled"
                ? <XCircle className="w-9 h-9 text-gray-300" />
                : tab === "done"
                  ? <CheckCircle2 className="w-9 h-9 text-gray-300" />
                  : <UtensilsCrossed className="w-9 h-9" style={{ color: "oklch(0.66 0.24 168)" }} />}
            </div>
              ...
              <>
                ...
                <Link href="/menu">
                  <button
                    ...
                    style={{ background: "oklch(0.66 0.24 168)" }}
                  >
                    ดูเมนู
                  </button>
                </Link>
